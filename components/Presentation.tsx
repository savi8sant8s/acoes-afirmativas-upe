...
export function Presentation({ id }: PresentationProps) {
    return (
        <div id={id} className="flex md:flex-row flex-col justify-items-center">
            <img className="p-8 text-center" width="300" height="100" src="logo.png" />
            <div className="m-auto p-8 text-justify">
                <strong className="text-2xl text-blupe">O que são ações afirmativas?</strong>
                <p className=" text-1.5xl text-blupe">
